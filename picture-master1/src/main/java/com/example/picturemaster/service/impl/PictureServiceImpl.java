...
import com.example.picturemaster.manager.upload.FilePictureUpload;
import com.example.picturemaster.manager.upload.PictureUploadTemplate;
import com.example.picturemaster.manager.upload.UrlPictureUpload;
import com.example.picturemaster.model.dto.file.UploadPictureResult;
...
import com.example.picturemaster.mapper.PictureMapper;
import com.example.picturemaster.service.SpaceService;
import com.example.picturemaster.service.UserService;
import com.example.picturemaster.utils.ColorSimilarUtils;
 ...
 * @createDate 2025-02-04 02:34:35
 */
@Slf4j
@Service
...
//        checkPictureAuth(loginUser, oldPicture);
    ...
    public List<PictureVO> searchPictureByColor(Long spaceId, String picColor, User loginUser) {
       ...
       //3.查询该空间下的所有图片（必须要有主色调）   查询指定空间下的图片，过滤掉没有图片颜色的数据，并返回list
       ...
       //将颜色字符串转换为主色调  先把picColor解析为Color对象
