...
import com.example.picturemaster.manager.auth.model.SpaceUserAuthConfig;
import com.example.picturemaster.manager.auth.model.SpaceUserPermissionConstant;
import com.example.picturemaster.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionsByRole(String spaceUserRole) {
        ...
        //先获取所有角色，转化为stream流，过滤当前要查询的角色=角色列表中的key，返回第一个
