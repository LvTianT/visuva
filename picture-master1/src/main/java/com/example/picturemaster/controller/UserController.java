...
import com.example.picturemaster.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        // 2. 打印日志：只记录我们已知的信息
        // loginUserVO 里应该已经包含了 token 和用户信息
        log.info("用户 {} 登录成功，返回的 token: {}", userAccount, loginUserVO.getToken());
   ...
   @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    /**
     * 分页获取用户封装列表（仅管理员），Postman接口测试要注释该接口
     *
