...
import com.example.picturemaster.api.aliyunai.AliYunAiApi;
...
import com.example.picturemaster.api.imagesearch.ImageSearchApiFacade;
import com.example.picturemaster.api.imagesearch.model.ImageSearchResult;
import com.example.picturemaster.common.DeleteRequest;
...
import com.example.picturemaster.model.enums.PictureReviewStatusEnum;
import com.example.picturemaster.model.vo.PictureTagCategory;
import com.example.picturemaster.model.vo.PictureVO;
...
//   */
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> categoryList = Arrays.asList("学习资料","深度学习","复试资料", "美食", "光感氛围", "高清", "动物", "头像", "毕业设计");
        List<String> tagList = Arrays.asList("模型", "实验","可视化结果","资料", "素材","食物", "美景", "绿意", "城市", "可爱");
    ...
    public BaseResponse<List<PictureVO>> searchPictureByColor(@RequestBody SearchPictureByColorRequest searchPictureByColorRequest, HttpServletRequest request) {
        ...
        User loginUser = userService.getLoginUser(request);
        List<PictureVO> picturVOList = pictureService.searchPictureByColor(spaceId, picColor, loginUser);
        return ResultUtils.success(picturVOList);
    }
}
